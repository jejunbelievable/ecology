...
class Camera: NSObject, ObservableObject {
    ...
    func capturePhoto() {
        ...
        let altitude = locationService.manager.location?.altitude as Any
        let latitude = locationService.manager.location?.coordinate.latitude as Any
        let longitude = locationService.manager.location?.coordinate.longitude as Any
        print(latitude)
        print(longitude)
        print(altitude)
        saveLocation(latitude:latitude,longitude:longitude,altitude:altitude)
        print("[Camera]: Photo's taken")
    }
    
    func saveLocation(latitude: Any, longitude: Any, altitude: Any){
        ...
        let path = homeDirURL.appendingPathComponent(fileName + ".txt")
        ...
        do {
            ...
            try jsonStr.write(to: path, atomically:false, encoding: .utf8)
        } catch let error {
    ...
    func savePhoto(_ imageData: Data) {
        ...
        let formatter = DateFormatter()
        formatter.dateFormat = "yyyy:MM:dd HH:mm:ss"
        let imageName = formatter.string(from:Date.now)
        print(imageName)
    ...
    func saveImage(imageName: String, image: UIImage) {
        ...
        let path = homeDirURL.appendingPathComponent(imageName+".png")
        do {
